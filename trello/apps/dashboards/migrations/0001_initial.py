    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_at', models.DateTimeField(auto_now=True, verbose_name='Update at')),
                ('is_active', models.BooleanField(default=True, verbose_name='Is Active')),
                ('title', models.CharField(help_text='Title of the list', max_length=150, verbose_name='Title')),
                ('board', models.ForeignKey(help_text='Board associated with the list', on_delete=django.db.models.deletion.CASCADE, related_name='board_lists', to='dashboards.board', verbose_name='Board')),
            ],
            options={
                'verbose_name': 'List',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'Work Spaces',
                'ordering': ['-create_at'],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.IntegerField(help_text='Order of the task', verbose_name='Order')),
                ...
                ('status', models.ForeignKey(help_text='Status of the task', on_delete=django.db.models.deletion.CASCADE, related_name='status_tasks', to='dashboards.list', verbose_name='Status')),
            ],
            options={
                'verbose_name': 'Task',
        ...
        migrations.AddField(
            model_name='board',
            name='work_space',
            field=models.ForeignKey(help_text='work space of the board', on_delete=django.db.models.deletion.CASCADE, related_name='work_space_boards', to='dashboards.workspace', verbose_name='Owner'),
        ),
        migrations.CreateModel(
            name='Attachment',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doer', models.ForeignKey(help_text='Author of the activity', on_delete=django.db.models.deletion.DO_NOTHING, related_name='author_activity', to=settings.AUTH_USER_MODEL, verbose_name='Author')),
